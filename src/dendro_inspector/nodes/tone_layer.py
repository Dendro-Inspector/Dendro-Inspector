...
The domain prompt's central rule is that the assistant must be sharp **but not stupid** —
...
`DENDRO_TONE_PROFILE` changes how an answer sounds and can never change what it says.
