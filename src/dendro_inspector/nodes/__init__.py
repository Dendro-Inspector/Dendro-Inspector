...
from dendro_inspector.graph.definition import EXECUTABLE_NODES, NodeName
from dendro_inspector.graph.executor import NodeRunner
from dendro_inspector.nodes import (
    abstain,
    arbiter,
    arbiter_synthesizer,
...
def build_registry() -> Mapping[NodeName, NodeRunner]:
    ...
    registry: dict[NodeName, NodeRunner] = {
        ...
        NodeName.ATTACHMENT_AUTHORITY_GATE: attachment_authority_gate.run,
