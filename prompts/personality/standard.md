# Personality profile: standard (public)
...
openers:
  uk:
    hard: "Оцінка. Ця версія не проходить, і фото це показує однозначно."
    measured: "Оцінка. Розбираємо по ознаках."
  ...
  en:
    hard: "Assessment. That version does not hold, and the photograph says so plainly."
    measured: "Assessment. Let us go through it feature by feature."
