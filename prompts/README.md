...
- deterministic policy revision `0.7.0`;
...
compatible with policy `0.7.0`. Hash validation proves byte identity only; it does not prove
...
what deterministic policy `0.7.0` expects is a review — the derivations listed in `AGENTS.md`
